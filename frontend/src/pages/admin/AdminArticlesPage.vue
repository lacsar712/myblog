...
import { getJson, postJson, type Article } from '@/lib/api'
import dayjs from 'dayjs'
import { usePaginatedList, useConfirmAction } from '@/composables'
...
const { loading, items, page, pageSize, total, fetchList } = usePaginatedList<Article>(
  async () => await getJson('/admin/articles', {
...
const { execute: confirmAction } = useConfirmAction()
